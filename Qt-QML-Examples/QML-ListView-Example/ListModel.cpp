    ...
    QAbstractListModel(parent)
{
    model = { { "Hamburger", "qrc:/res/hamburger.png", "A hamburger, or simply burger, is a food consisting of fillings—usually a patty of ground meat,"
              ...
              { "Donut", "qrc:/res/donut.png", "A doughnut or donut is a type of food made from leavened fried dough. It is popular in many countries and"
              ...
              { "Pizza", "qrc:/res/pizza.png", "Pizza is a dish of Italian origin consisting of a usually round, flat base of leavened wheat-based"
              ...
              { "Ice-cream", "qrc:/res/ice-cream.png", "Ice cream is a sweetened frozen food typically eaten as a snack or dessert. It may be made from"
