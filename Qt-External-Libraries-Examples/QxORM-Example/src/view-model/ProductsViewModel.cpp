...
auto ProductsViewModel::data(const QModelIndex& index, int role) const -> QVariant
{
    ...
    if (role == Qt::DisplayRole) {
        switch (index.column()) {
        case 0: return products.at(index.row())->id;
        case 1: return products.at(index.row())->product_type;
        case 2: return products.at(index.row())->product_name;
        case 3: return products.at(index.row())->manufacturer;
        case 4: return products.at(index.row())->product_count;
        case 5: return products.at(index.row())->price;
