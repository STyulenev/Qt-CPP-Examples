...
Данные выводятся через view-model в QTableView.

[Ссылка на исходники libpqxx](https://github.com/jtv/libpqxx "libpqxx")

![alt text](doc/libpqxx-Example.png)

## Сборка проекта

1. Скачать и установить PostgreSQL.
2. Скачать libpqxx и указать пути в CMakeLists.txt
