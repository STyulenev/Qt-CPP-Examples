...
Пример использования библиотеки libharu для создания pdf-файлов.

[Ссылка на исходники libharu](https://github.com/libharu/libharu "libharu")

![alt text](doc/libharu-Example.png)
